...
x_train = np.reshape(x_train,(len(train['images']),150,150, 3))
...
model=CNN(3)
checkpointer = ModelCheckpoint(filepath='model2.h5', verbose=1, save_best_only=True ,monitor='val_accuracy')
